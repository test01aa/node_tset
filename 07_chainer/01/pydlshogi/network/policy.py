...
class PolicyNetwork(Chain):
    def __init__(self):
        ...
        with self.init_scope():
            self.l01 = L.Convolution2D(in_channels = 104, out_channels = ch, ksize = 3, pad = 1)
            self.l02 = L.Convolution2D(in_channels = ch , out_channels = ch, ksize = 3, pad = 1)
            self.l03 = L.Convolution2D(in_channels = ch , out_channels = ch, ksize = 3, pad = 1)
            self.l04 = L.Convolution2D(in_channels = ch , out_channels = ch, ksize = 3, pad = 1)
            self.l05 = L.Convolution2D(in_channels = ch , out_channels = ch, ksize = 3, pad = 1)
            self.l06 = L.Convolution2D(in_channels = ch , out_channels = ch, ksize = 3, pad = 1)
            self.l07 = L.Convolution2D(in_channels = ch , out_channels = ch, ksize = 3, pad = 1)
            self.l08 = L.Convolution2D(in_channels = ch , out_channels = ch, ksize = 3, pad = 1)
            self.l09 = L.Convolution2D(in_channels = ch , out_channels = ch, ksize = 3, pad = 1)
